	...
	<div>
		<div class="admin-table">
			<table class="table">
				<thead>
				<tr>
					<th class="text-align-l padding-ten" width="300">功能</th>
				...
				<tbody>
				<tr>
					<td class="text-align-l padding-ten" >语音通知</td>
				...
				<tr>
					<td class="text-align-l padding-ten" >语音回拨</td>
				...
				<tr>
					<td class="text-align-l padding-ten" >语音会议</td>
				...
				<tr>
					<td class="text-align-l padding-ten" >语音验证码</td>
				...
				<tr>
					<td class="text-align-l padding-ten" >通话录音</td>
				...
				<tr>
					<td class="text-align-l padding-ten" >自定义IVR</td>
