			...
			<div class="panel panel-base">
				...
				<div class="panel-body admin-bg flex-1">
					<ul class="list-none-style">
						...
						<li>选择类型: <span v-if="app.service_type ==='voice'">语音</span><span	 v-if="service_type==='call_center'">呼叫中心</span> </li>
	...
	<div class="bg-section-margin">
		<div class="flex   ">
			<div class="admin-toolbar inline-block normal-font-size small-font-color cursor" >
				<span type="button" class="toolbar first-toolbar"  v-link="'/admin/tenant/detail/'+$route.params.uid+'/app/detail/'+$route.params.appid+'/extension'" >分机</span>
