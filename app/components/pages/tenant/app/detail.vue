		...
		<div class="admin-panel flex-1">
			<div class="panel-body">
				<ul class="list-none-style">
					<li>
						<button class="btn btn-primary" v-link="'/admin/tenant/detail/'+$route.params.uid+'/app'">返回应用列表</button>
					</li>
					<li>应用名称: 飞飞语音22222</li>
					<li>应用类型: 网页</li>
				...
				<div class="btn-group">
					<button class="btn">放音媒体库</button>
					<button class="btn">录音文件</button>
				</div>
			</div>
		</div>
